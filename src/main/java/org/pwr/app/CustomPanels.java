...
public class CustomPanels {
    public static JPanel createSpinnerInputPanel(String label, int min, int max, SpinnerChangeListener spinnerChangeListener) {
    ...
    public static JPanel createSliderInputPanel(String label, int min, int max, SliderChangeListener sliderChangeListener) {
    ...
    public static JPanel createCheckBoxInputPanel(String label, CheckBoxActionListener checkBoxActionListener) {
